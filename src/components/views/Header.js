...
class Header extends Component {
  ...
  render() {
    ...
    return (
      <header>
          <Container fluid style={{ position: "fixed", top: "0", zIndex: "99999", width: "100%" }}>
            <Row>
              <Navbar expand="lg">
                <div className="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-2">
                    <Link to="/" style={{ fontFamily: "fantasy", fontSize: "2rem",  color: 'black' }}>
                        Kstore
                    </Link>
                </div>
                ...
                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div className="fix-card">
                        ...
                        <form onSubmit={this.handleSubmit}>
                            <input placeholder="Search products" className="input-val" onChange={this.handleChange} />
